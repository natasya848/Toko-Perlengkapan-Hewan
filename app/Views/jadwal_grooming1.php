    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Data Jadwal Layanan Grooming yang Dihapus</h3>
            </div>
        </div>
    </div>
        ...
        <div class="card-body">
            <div class="table-responsive">
                <?php if (!empty($deleted_jadwal)): ?>    
                    ...
                    <tbody>
                        <?php $no = 1; foreach ($deleted_jadwal as $j): ?>
                        <tr>
                            <td><?= $no++ ?></td>
                            <td><?= $j->hari ?></td>
                            ...
                            <td>
                                ...
                                <?php endif ?>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                        <a href="<?= base_url('home/restoreJadwal/' . $j->id_jadwal) ?>" class="btn btn-success btn-sm me-2">
                                            <i class="fa fa-undo"></i></a>
                                        <a href="<?= base_url('home/hapusJadwal/' . $j->id_jadwal) ?>" 
                ...
                <?php else: ?>
                    <p class="text-center">Tidak ada jadwal layanan grooming yang dihapus.</p>
                <?php endif; ?>
            </div>
        </div>
    </div>
...
<div class="position-fixed bottom-3 end-3">
    <a href="<?= base_url('home/jadwal_grooming') ?>" class="btn btn-secondary shadow">
