    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Data Layanan Grooming yang Dihapus</h3>
            </div>
        </div>
    </div>
            ...
            <div class="table-responsive">
                <?php if (!empty($deleted_grooming)): ?>    
                    <table class="table table-striped" id="table9">
                        ...
                        <tbody>
                            <?php $no = 1; foreach ($deleted_grooming as $p): ?>
                                <tr>
                                    <td><?= $no++ ?></td>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                        <a href="<?= base_url('home/restoreGrooming/' . $p->id_layanan) ?>" class="btn btn-success btn-sm me-2">
                                            <i class="fa fa-undo"></i></a>
                                        <a href="<?= base_url('home/hapusGrooming/' . $p->id_layanan) ?>" 
                ...
                <?php else: ?>
                    <p class="text-center">Tidak ada layanan grooming yang dihapus.</p>
                <?php endif; ?>
            </div>
        </div>
    </div>
