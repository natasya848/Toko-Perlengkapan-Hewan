   	...
   	<section class="section">
    	<div class="card p-3">
        	<div class="d-flex justify-content-between align-items-start flex-wrap">
                ...
                <a href="<?= base_url('home/cetak_nota/' . $pesanan->id_pesanan) ?>" class="btn btn-info mt-2" target="_blank">
        ...
        <div class="card-body">
            ...
            <div class="position-fixed bottom-3 end-3">
                <a href="<?= base_url('home/rekap_pesanan') ?>" class="btn btn-secondary shadow">
