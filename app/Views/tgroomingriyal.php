...
<div class="page-heading">
   ...
   <section class="section">
    <div class="card p-4">
        <form action="<?= base_url('home/tgroomingriyal') ?>" method="post">
            ...
            <div class="d-flex gap-2 mt-3">
                ...
                <a href="<?= base_url('home/jadwal_grooming') ?>" class="btn btn-danger"><i class="bi bi-x-circle"></i> Batal</a>
            </div>
        </form>
    </div>
</section>
